...
class HttpProvider {
    ...
    getReleasesMovies(page) {
        const url = this._createUrl(_constants_api__WEBPACK_IMPORTED_MODULE_1__["RELEASES_MOVIES"], page);
        return this._getResponseHttpClient(url);
    }
    getPopularMovies(page) {
        const url = this._createUrl(_constants_api__WEBPACK_IMPORTED_MODULE_1__["POPULAR_MOVIES"], page);
        return this._getResponseHttpClient(url);
    }
    getTopRatedMovies(page) {
        const url = this._createUrl(_constants_api__WEBPACK_IMPORTED_MODULE_1__["TOP_RATED_MOVIES"], page);
        return this._getResponseHttpClient(url);
    }
    getInfoMovies(idMovie) {
        const url = this._createUrl(_constants_api__WEBPACK_IMPORTED_MODULE_1__["DETAILS_MOVIE"].replace('<id>', idMovie.toString()));
        return this._getResponseHttpClient(url);
    }
    getListGenders() {
        const url = this._createUrl(_constants_api__WEBPACK_IMPORTED_MODULE_1__["GENRES"]);
        return this._getResponseHttpClient(url);
    }
    _createUrl(uri, page) {
