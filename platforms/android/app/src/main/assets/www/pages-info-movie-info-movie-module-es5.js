...
var CardMovieInfoComponent = /** @class */ (function () {
    function CardMovieInfoComponent() {
        this.infoMovie = {};
    }
...
var InfoMoviePageRoutingModule = /** @class */ (function () {
    function InfoMoviePageRoutingModule() {
    }
    ...
    return InfoMoviePageRoutingModule;
}());
...
var InfoMoviePageModule = /** @class */ (function () {
    function InfoMoviePageModule() {
    }
...
var InfoMoviePage = /** @class */ (function () {
    function InfoMoviePage(_activatedRoute, _httpProvider) {
        var _this = this;
        ...
        this._activatedRoute.params.subscribe(function (params) {
            _this.params = params;
            _this.infoMovie$ = _this._httpProvider.getInfoMovies(_this.params.id);
        });
    }
    InfoMoviePage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.lastSubscribes = this.infoMovie$
            .subscribe(function (infoMovie) { return _this.infoMovie = infoMovie; });
    };
    InfoMoviePage.prototype.ionViewWillLeave = function () {
        this.lastSubscribes.unsubscribe();
    };
    InfoMoviePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-info-movie-info-movie-module-es5.js.map